...
def chained_matched_index(
    ...
    (No range grouping: guessing "families" from slugs merged competing brands
    and barely caught real ranges. The reference-price series already keeps a
    promotion on N variants from being read as inflation, which was the point.)
